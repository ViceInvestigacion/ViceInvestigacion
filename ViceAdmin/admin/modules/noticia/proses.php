            ...
            if (isset($_POST['id_Noticia'])) {
                ...
                if (empty($nama_file)) {
                    // consultar comando para cambiar los datos de la tabla nosotrosBE
                     $query = sqlsrv_query($mysqli, "UPDATE noticiaBE SET 
                        titulo_Noticia='$titulo',
                        descripcion_Noticia = '$descripcion ',
                        fecha_Noticia='$fecha',
                                     usuReg_Noticia='$user_id'
                        WHERE id_Noticia = '$id'")
                    ...
                    if ($query) {
                        ...
                        header("location: ../../main.php?module=noticia&alert=2");
                    } 
                }
    ...
    elseif ($_GET['act']=='delete') {
        if (isset($_GET['id_Noticia'])) {
            ...
            // consultar comando para eliminar los datos de la tabla nosotrosBE
             $query = sqlsrv_query($mysqli, "DELETE FROM noticiaBE WHERE id_Noticia='$id'")
            ...
            if ($query) {
                ...
                header("location: ../../main.php?module=noticia&alert=3");
            }
        }
    }       
}       
