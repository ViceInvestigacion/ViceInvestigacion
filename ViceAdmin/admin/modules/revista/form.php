...
if ($_GET['form']=='add') { ?> 
  ...
  <section class="content-header">
    <h1>
      <i style="margin-right:7px" class="fa fa-edit"></i> Agregar Revista
    </h1>
    <ol class="breadcrumb">
          ...
          <form role="form" class="form-horizontal" method="POST" action="modules/revista/proses.php?act=insert" method="POST" enctype="multipart/form-data">
            <div class="box-body">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-8">
                  <input type="text" class="form-control" name="contenido" autocomplete="off" required>
                </div>
              </div>
...
elseif ($_GET['form']=='edit') { 
  if (isset($_GET['id'])) {
      ...
      $query = mysqli_query($mysqli, "SELECT * FROM is_revista WHERE revista_id='$_GET[id]'") 
        ...
        <div class="box box-primary">
          ...
          <form role="form" class="form-horizontal" method="POST" action="modules/revista/proses.php?act=update" method="POST" enctype="multipart/form-data">
            <div class="box-body">
              ...
              <input type="hidden" name="revista_id" value="<?php echo $data['revista_id']; ?>">

              <div class="form-group">
                <label class="col-sm-1 control-label">Título</label>
                <div class="col-sm-8">
                  <input type="text" class="form-control" name="title" autocomplete="off" value="<?php echo $data['tittle']; ?>" required>
                </div>
              </div>
              ...
              <div class="form-group">
                <label class="col-sm-1 control-label">Contenido</label>
                <div class="col-sm-8">
                  <input type="text" class="form-control" name="contenido" autocomplete="off" value="<?php echo $data['contenido']; ?>" required>
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-8">
                  ...
                  <br>
                  <img src="../images/revista/<?php echo $data['image']; ?>" height="150">
                </div>
              </div>
