...
<section class="content-header">
  <h1>
    <i class="fa fa-bell icon-title"></i> Revista
  ...
  <div class="row">
    ...
    elseif ($_GET['alert'] == 1) {
      echo "<div class='alert alert-success alert-dismissable'>
              ...
              La nueva revista se ha guardado con éxito.
            </div>";
    }
    ...
    elseif ($_GET['alert'] == 2) {
      echo "<div class='alert alert-success alert-dismissable'>
              <button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>
              <h4>  <i class='icon fa fa-check-circle'></i> Bien hecho</h4>
              La revista ha sido actualizado exitosamente.
            </div>";
    }
    ...
    elseif ($_GET['alert'] == 3) {
      echo "<div class='alert alert-success alert-dismissable'>
              <button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>
              <h4>  <i class='icon fa fa-check-circle'></i> Bien hecho!</h4>
              La revista ha sido eliminado exitosamente.
            </div>";
    }
    ...
    ?>
      ...
      <div class="box box-primary">
          <table id="dataTables1" class="table table-bordered table-striped table-hover">
            ...
            $query = mysqli_query($mysqli, "SELECT * FROM is_revista ORDER BY revista_id DESC")
            ...
            while ($data = mysqli_fetch_assoc($query)) { 
              ...
              echo "<tr>
                      ...
                      <td width='150'>$data[tittle]</td>
                      <td width='150'>$data[contenido]</td>
                      <td width='200' class='center'>
                        <img src='../images/revista/$data[image]' height='150'>
                      </td>
                      <td class='center' width='80'>
                        <div>
                          <a data-toggle='tooltip' data-placement='top' title='Editar' style='margin-right:5px' class='btn btn-primary btn-sm' href='?module=form_revista&form=edit&id=$data[revista_id]'>
                              <i style='color:#fff' class='glyphicon glyphicon-edit'></i>
                          </a>";
            ?>
                          <a data-toggle="tooltip" data-placement="top" title="Eliminar" class="btn btn-danger btn-sm" href="modules/revista/proses.php?act=delete&id=<?php echo $data['revista_id'];?>" onclick="return confirm('Estas seguro que quieres eliminar <?php echo $data['title']; ?> ?');">
